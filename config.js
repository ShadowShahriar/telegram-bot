...
const sketchReminderGIFs = ['anime-sketching', 'anime-drawing']

const reminders = [
	['শাহ্‌রিয়ার আছো নাকি?', 'নতুন কোন গল্প লেখার আইডিয়া মাথায় এসেছে নাকি?'],
